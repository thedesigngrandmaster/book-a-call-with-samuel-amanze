        ...
        <div className="flex items-center gap-2">
          ...
          {user ? (
            <>
              ...
              <Link to={role === "admin" ? "/account" : "/account"} className="flex items-center gap-2 rounded-full border border-border bg-surface py-1 pl-1 pr-3 hover:bg-surface-hover">
                {role === "admin" ? (
                  <img
                    src="/me.jpg"
                    alt="Samuel AMANZE"
